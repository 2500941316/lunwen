...
public class FileUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("开始——汪汪汪汪");
        //切割文件
        int count = getSplitFile(file, 1024 * 1024);
        byte[] bytes = DigestUtils.md5(new FileInputStream(file));
        String fileMD5 = new String(Base64.getEncoder().encode(bytes));
        for (int i = 0; i < count; i++) {
            String fileName = "C:\\Users\\Administrator\\Desktop\\test\\test_" + i + ".tmp";
            Post.Post(fileName, count, i, fileMD5);
        }
